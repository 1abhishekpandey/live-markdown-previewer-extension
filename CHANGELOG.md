...
- Keep native VS Code file shortcuts (rename, delete, etc.) working on `.md` preview tabs
- Match VS Code's native undo/redo/save timing so edits group and persist correctly
