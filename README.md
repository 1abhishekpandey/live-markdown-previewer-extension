...
[![VS Code](https://img.shields.io/visual-studio-marketplace/v/1AbhishekPandey.live-markdown?label=VS%20Code&color=blue)](https://marketplace.visualstudio.com/items?itemName=1AbhishekPandey.live-markdown)
[![Cursor](https://img.shields.io/open-vsx/v/1AbhishekPandey/live-markdown?label=Cursor&color=purple)](https://open-vsx.org/extension/1AbhishekPandey/live-markdown)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/1abhishekpandey/live-markdown-previewer-extension/blob/main/LICENSE)
...
- **Native undo/redo** — keystrokes batch into groups with VS Code / Word timing (500 ms pause breaks a group); edits land in the document immediately so `files.autoSave` fires with no extra delay
...
[MIT](https://github.com/1abhishekpandey/live-markdown-previewer-extension/blob/main/LICENSE)
